...
CString CTLiteDoc::GetTimeStamString(int time_stamp_in_min)
{
	CString str;
...
void CTLiteDoc::OnExportGeneratezone()
{
	...
	AfxMessageBox("Please check file output_travel_time_matrix.csv.", MB_ICONINFORMATION);
