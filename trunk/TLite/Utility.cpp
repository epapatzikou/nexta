...
int g_P2P_Angle(GDPoint p1, GDPoint p2)
{
...
int g_PPP_RelativeAngle(GDPoint p1, GDPoint p2, GDPoint p3)
{
 int relative_angle;

 int angle1 = g_P2P_Angle(p1,p2);
 int angle2 = g_P2P_Angle(p2,p3);
...
DTA_Turn g_RelativeAngle_to_Turn(int relative_angle)
{
...
DTA_Turn g_PPP_to_Turn(GDPoint p1, GDPoint p2, GDPoint p3)
{
	...
	int relative_angle = g_PPP_RelativeAngle(p1,p2,p3);
	return g_RelativeAngle_to_Turn(relative_angle);
...
DTA_Approach g_Angle_to_Approach(int angle)
{
      if(angle < 75) // North
      {
	  return DTA_South;
