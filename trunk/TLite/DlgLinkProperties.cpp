...
BOOL CDlgLinkProperties::OnInitDialog()
{
	CDialog::OnInitDialog();
		...
		m_LinkTypeComboBox.AddString ("1.Freeway");
		m_LinkTypeComboBox.AddString ("2.Highway/Expressway");
		m_LinkTypeComboBox.AddString ("3.Principal arterial");
		m_LinkTypeComboBox.AddString ("4.Major arterial");
		m_LinkTypeComboBox.AddString ("5.Minor arterial");
		m_LinkTypeComboBox.AddString ("6.Collector");
		m_LinkTypeComboBox.AddString ("7.Local");
		m_LinkTypeComboBox.AddString ("8.Frontage road");
		m_LinkTypeComboBox.AddString ("9.Ramp");
		m_LinkTypeComboBox.AddString ("10.Zonal Connector");
